                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <form name="addcontent" id="addcontent"
                                      action="${pageContext.request.contextPath}/add-content" onsubmit="return validateForm()"
                                      method="post">
                                    ...
                                    <div class="form-group">
                                        <label>Brief</label>
                                        <textarea class="form-control" rows="3" name="brief" id="briefValue"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Content</label>
                                        <textarea class="form-control" rows="8" name="content"
                                                  id="contentValue"></textarea>
                                    </div>
