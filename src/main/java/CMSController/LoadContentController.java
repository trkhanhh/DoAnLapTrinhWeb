...
@WebServlet(urlPatterns = {"/view-content"})
public class LoadContentController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int maxPage = 10;
        List<ContentModel> contentModels = contentdao.getall( maxPage, startIndex);
        if(search == null){
            search = "";
        }
